...
read_1 = SeqIO.parse("/data/home/bt211032/scratch/research_project/2022-04-08-mappy_seq_monkk/input/SRR15503419_1.fastq", "fastq")
read_2 = SeqIO.parse("/data/home/bt211032/scratch/research_project/2022-04-08-mappy_seq_monkk/input/SRR15503419_2.fastq", "fastq")
...
# read_1 = SeqIO.parse("/data/home/bt211032/scratch/research_project/2022-06-11-seq_depth/input/sim750M-R1.fq", "fastq")
# read_2 = SeqIO.parse("/data/home/bt211032/scratch/research_project/2022-06-11-seq_depth/input/sim750M-R2.fq", "fastq")
    ...
    while upper_bound < values[0][-1]:
        ...
        if len(L1_start_ls) >= 1:
            ...
            if chromosome in var_dict:
                var_dict[chromosome].append((variance, lower_bound, upper_bound, L1_start_ls, len(L1_start_ls)))
            # addition of information for a new chr record 
            else:
                var_dict[chromosome] = [(variance, lower_bound, upper_bound, L1_start_ls, len(L1_start_ls))]
...
with open("results/window.tsv", "wt") as out_file:
    ...
    # writing the header
    tsv_writer.writerow(['chr', 'var', 'start_hg38', 'end_hg38', "L1_start", "num_L1_start"])
