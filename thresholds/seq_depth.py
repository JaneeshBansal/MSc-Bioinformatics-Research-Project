...
read_1 = SeqIO.parse("/data/home/bt211032/scratch/research_project/2022-05-09-simulated_data/input_py/10M_sim-R1.fastq", "fastq")
read_2 = SeqIO.parse("/data/home/bt211032/scratch/research_project/2022-05-09-simulated_data/input_py/10M_sim-R2.fastq", "fastq")
...
output_txt = open("results_sim10M/mapped.txt", "a")
...
with open("results_sim10M/window.tsv", "wt") as out_file:
